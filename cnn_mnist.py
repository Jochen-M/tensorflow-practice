...
if __name__ == "__main__":
    ...
    # cnn layer 1
    W_conv1 = CNN.weight_variable([5, 5, 1, 32])
    b_conv1 = CNN.bias_variable([32])
    h_conv1 = tf.nn.relu(CNN.conv2d(x_image, W_conv1) + b_conv1)
    ...
    W_fc1 = CNN.weight_variable([7*7*64, 1024])
    ...
    W_fc2 = CNN.weight_variable([1024, 10])
    b_fc2 = CNN.bias_variable([10])
